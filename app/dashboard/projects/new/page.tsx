...
export default function NewProjectPage() {
  ...
  return (
    <div style={{
      minHeight: '100vh', background: '#0d0d0f', display: 'flex', alignItems: 'center',
      justifyContent: 'center', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', padding: 24,
    }}>
      <div style={{ width: '100%', maxWidth: 480 }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h1 style={{ color: '#fff', fontSize: 22, fontWeight: 700, margin: 0 }}>Novo Projeto</h1>
          <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: 14, marginTop: 6 }}>
            Cole a URL do protótipo e comece a revisar
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <button
            ...
            style={{
              ...
              color: '#fff', cursor: loading ? 'not-allowed' : 'pointer', transition: 'background 0.15s',
            }}
          >
            {loading ? 'Criando…' : 'Abrir Review →'}
          </button>
        </form>
